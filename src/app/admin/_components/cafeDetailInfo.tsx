    ...
    <div>
      ...
      >
        <div className="bg-beige-200 rounded-lg shadow-lg">
          ...
          {/* 店舗情報 */}
          <div className="font-bold p-5 flex flex-col justify-between h-full">
              <h3 className="py-5 overflow-auto max-w-md whitespace-pre-wrap break-words">{cafe.cafeName}</h3>
              <p className="py-5">星評価  {RenderStars(cafe.starRating)}</p>
            <p className="py-5">エリア  {cafe.area}</p>
            <p className=" w-full max-h-[300px] overflow-auto max-w-md whitespace-pre-wrap break-words">おすすめ理由 <br /> {cafe.comment}</p>
            <div className="text-center ">
            <button
              className="mt-4 p-2 bg-red-500 text-white rounded"
              onClick={(e) => {
