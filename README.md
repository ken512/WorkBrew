...
| カフェ投稿画面 | 投稿一覧画面 |
| -------------- | ------------ |
| <img src="/docs/img/カフェ投稿.png" width="300" /> | <img src="/docs/img/投稿一覧.png" width="300" /> |
| カフェ投稿するページ画面です。作業場所で最低限知りたい情報のみ必須項目にしています。 | 投稿されたカフェを一覧で表示する画面です。フィルター検索で、店名・エリア、Wi-Fi・電源の有無の項目で、知りたい情報を絞ることができます。 |

| カフェ詳細画面 | ユーザーアカウント画面 |
| -------------- | ---------------------- |
| <img src="/docs/img/カフェ詳細.png" width="300" /> | <img src="/docs/img/ユーザーアカウント.png" width="300" /> |
...
| お気に入り一覧画面 | ホーム画面 |
| ------------------ | ---------- |
| <img src="/docs/img/お気に入り一覧.png" width="300" /> | <img src="/docs/img/ホーム画面.png" width="300" /> |
